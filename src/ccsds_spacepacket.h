...
namespace CCSDS 
{
  ...
  public:
     ...
     *
     * The implementation of this callback shall handle the space packet. It shall implement the forwarding to the
     * corresponding application (or the further processing of the content).
     *
     * @param e_PacketType       The packet type (TM or TC)
     * @param e_SequenceFlags    The sequence flags (Continuation, First, Last Segment or Unsegmented)
  ...
  private:
    ...
    ESpacePacketType me_PacketType;
    bool mb_SecHdrFlag;
    uint16_t mu16_APID;
